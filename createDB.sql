...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `musicTracker`.`AlbumSummaries` (`Album_Title` INT, `recordLabel` INT, `releaseDate` INT, `Song_Title` INT, `duration` INT, `track_number` INT, `Artist_Name` INT);
