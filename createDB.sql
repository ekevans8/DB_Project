...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `musicTracker`.`PerformanceSummary` (`performanceId` INT, `title` INT, `duration` INT, `date` INT, `VenuName` INT, `streetAddress` INT, `city` INT, `state` INT, `zipcode` INT, `SongTitle` INT, `Artist` INT, `artistId` INT, `venueId` INT);
